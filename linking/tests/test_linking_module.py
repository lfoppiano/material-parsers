...
class TestUtilitiesMethods:
    ...
    def test_covert_to_spacy(self):
        ...
        spans = [{'id': 3183758168641928847, 'text': 'T c ', 'type': '<tc>', 'offsetStart': 13, 'offsetEnd': 17, 'tokenStart': 1, 'tokenEnd': 2, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': 2850964293203602307, 'text': '30', 'type': '<tcValue>', 'offsetStart': 24, 'offsetEnd': 26, 'tokenStart': 4, 'tokenEnd': 4, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': -7289024069834629803, 'text': '37.7', 'type': '<tcValue>', 'offsetStart': 28, 'offsetEnd': 32, 'tokenStart': 5, 'tokenEnd': 7, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': 414589195323464845, 'text': '36', 'type': '<tcValue>', 'offsetStart': 34, 'offsetEnd': 36, 'tokenStart': 7, 'tokenEnd': 8, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': -6841720698725589771, 'text': '27.5 ', 'type': '<tcValue>', 'offsetStart': 38, 'offsetEnd': 43, 'tokenStart': 9, 'tokenEnd': 11, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': -7747294031880326267, 'text': '20.3 ', 'type': '<tcValue>', 'offsetStart': 47, 'offsetEnd': 52, 'tokenStart': 12, 'tokenEnd': 14, 'boundingBoxes': [], 'links': [], 'linkable': False}, {'id': 'x14', 'text': 'x = 0.10', 'type': '<material>', 'offsetStart': 58, 'offsetEnd': 66, 'tokenStart': 15, 'tokenEnd': 19, 'boundingBoxes': [], 'links': [], 'linkable': True}, {'id': 'x15', 'text': '0.15', 'type': '<material>', 'offsetStart': 68, 'offsetEnd': 72, 'tokenStart': 19, 'tokenEnd': 22, 'boundingBoxes': [], 'links': [], 'linkable': True}, {'id': 'x16', 'text': '0.20', 'type': '<material>', 'offsetStart': 74, 'offsetEnd': 78, 'tokenStart': 22, 'tokenEnd': 24, 'boundingBoxes': [], 'links': [], 'linkable': True}, {'id': 'x17', 'text': '0.22 ', 'type': '<material>', 'offsetStart': 80, 'offsetEnd': 85, 'tokenStart': 24, 'tokenEnd': 26, 'boundingBoxes': [], 'links': [], 'linkable': True}, {'id': 'x18', 'text': '0.24', 'type': '<material>', 'offsetStart': 89, 'offsetEnd': 93, 'tokenStart': 26, 'tokenEnd': 29, 'boundingBoxes': [], 'links': [], 'linkable': True}]
        outputTokens, outputSpaces, outputSpans = SpacyPipeline.convert_to_spacy(tokens, spans)

        print("bao")
        for span in outputSpans:
            assert "".join(outputTokens[span['tokenStart']:span['tokenEnd']]) == span['text']
            assert text[span['offsetStart']:span['offsetEnd']] == span['text']
